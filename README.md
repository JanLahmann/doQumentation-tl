# doQumentation — Tagalog/Filipino

This is a deployment repository for [tl.doqumentation.org](https://tl.doqumentation.org), the Tagalog/Filipino version of [doQumentation](https://doqumentation.org).
